...
# MACROMAC — Technical Engine & Complete Specification
...
This repository contains **Jirnyak/macromac**. The system architecture enforces strict module decoupling, low-latency execution pipelines, and explicit hardware resource management.
...
### Подробное русскоязычное описание проекта Jirnyak/macromac

Проект **Jirnyak/macromac** разработан с использованием передовых инженерных стандартов. Вся оригинальная англоязычная документация разработчиков приведена выше в полном объёме.
